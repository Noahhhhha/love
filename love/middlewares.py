...
class LoveDownloaderMiddleware(object):
    ...
    # 代理来源于小二代理
    proxysFrom = \
    json.loads(requests.get('http://api.xedl.321194.com/getip?num=200&type=2&port=1&pack=2196&ts=1&cs=1&lb=1').text)[
        "data"]

    # PROXIES = [
    #            "http://60.13.42.83:9999",
    #            "http://49.70.17.167:9999",
    #            "http://106.12.116.128:808",
    #            "http://175.44.159.33:9000",
    #            "http://117.90.1.252:9000"]
    ...
    def process_request(self, request, spider):
        ...
        # 设置随机调用的代理
        proxys = []
        for x in self.proxysFrom:
            # x是列表中的字典
            y = 'http://'+ x["ip"] + ':' + str(x["port"])
            proxys.append(y)
